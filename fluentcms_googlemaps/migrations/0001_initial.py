    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('center', geoposition.fields.GeopositionField(default='0,0', max_length=42, verbose_name='Map center')),
        ...
        migrations.AddField(
            model_name='mapitem',
            name='groups',
            field=models.ManyToManyField(related_name='mapitems', db_table='contentitem_fluentcms_googlemaps_mapitem_groups', verbose_name='Marker Groups', to='fluentcms_googlemaps.MarkerGroup'),
            preserve_default=True,
        ),
    ]
